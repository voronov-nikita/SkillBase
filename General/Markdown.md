...
2. **Вставка (изображения, гиперссылки куски кода и т.д)**:
    ...
    > [!IMPORTANT]
    > В контексте LaTeX работа с markdown может быть не совсем уместной, однако даже в самом начале (в заголовке файла) прописать ряд специальных библиотек, которые будут работать и переводить нормальный вид в код LaTeX.
